import torch
# from torchmetrics import RetrievalMAP, RetrievalNormalizedDCG, RetrievalMRR, RetrievalPrecision
from torchmetrics.retrieval import RetrievalMAP, RetrievalNormalizedDCG, RetrievalMRR, RetrievalPrecision
import json
...
def rank(test_sim_score_matrix, ranking_num, test_query_list, test_label_list):
    ...
    for i in range(len(c_list)):
        ...
        for j in range(len(c_list[i])):
            ...
            case_name = test_label_list[predict_ind]
